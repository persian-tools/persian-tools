...
<CodeGroup>
```html jsdelivr
<script src="https://cdn.jsdelivr.net/npm/persian-tools@latest/build/persian-tools.min.js"></script>
```

```html unpkg
<script src="https://unpkg.com/persian-tools@latest/build/persian-tools.min.js"></script>
```
...
<Card title="Compatibility" icon="check-circle">
	- **Node.js**: 14+ (ESM and CommonJS support) - **Bun**: Latest versions - **Browsers**: Modern browsers with
	ES2018+ support - **TypeScript**: 4.0+ (optional, but recommended)
</Card>

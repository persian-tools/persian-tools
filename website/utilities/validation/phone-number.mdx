...
<Accordion title="Contact Management" icon="address-book">
	Store and validate contacts: ```typescript const contacts = userContacts.filter(contact =>
...
<Tip>Always validate phone numbers before sending SMS or making calls.</Tip>

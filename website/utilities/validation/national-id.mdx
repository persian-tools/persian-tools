...
<AccordionGroup>
  ...
  <Accordion title="📊 Benchmark Results" icon="chart-bar">
...
<Warning>
	National ID validation should be used alongside other verification methods. A valid checksum doesn't guarantee the
	ID belongs to the person claiming it.
</Warning>
